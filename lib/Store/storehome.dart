...
import 'package:pazada/Store/product_page.dart';
            ...
            builder: (context, dataSnapshot)
            {
              return !dataSnapshot.hasData
                  ...
                  : SliverStaggeredGrid.countBuilder(
                      ...
                      {
                        ItemModel model = ItemModel.fromJson(dataSnapshot.data.docs[index].data());//dataSnapshot.data.documents[index].data
                ...
                children: [
                  ...
                  Container(
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(model.title, style: TextStyle(color: Colors.black, fontSize: 14.0, fontFamily: 'bolt-bold'),),
                        ),
                      ],
                    ),
                  ),
                  ...
                  Container(
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(model.longDescription, style: TextStyle(color: Colors.black54, fontSize: 12.0, fontFamily: 'bolt'),),
                        ),
                      ],
                    ),
                  ),
...
{
  PazabuyApp.sharedPreferences.getStringList(PazabuyApp.userCartList).contains(shortInfoAsID)
